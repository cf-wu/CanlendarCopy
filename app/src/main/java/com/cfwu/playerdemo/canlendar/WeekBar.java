 ...
 */
package com.cfwu.playerdemo.canlendar;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.cfwu.playerdemo.canlendar.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.cfwu.playerdemo.canlendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
